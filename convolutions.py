...
def convolve(image, K):
    ...
    for y in np.arange(pad, iH + pad):
        for x in np.arange(pad, iW + pad):
            ...
            # perform the actual convolution by taking the element-wise multi-
            # plication between the ROI and the kernel, then summing the matrix
            k = (roi * K).sum()
...
route="C:/Users/rafae/Documents/Artificial Intelligence/1_DL for computer vision/datasets/"
image = cv2.imread(route+args["image"])
